...
void CDBlock::CmdMpegSetWindow() {
    ...
    //   CR2 = first parameter word
    //   CR3 = second parameter word
    //   CR4 = third parameter word
    //
    ...
    devlog::info<grp::cmd>("-> MPEG set window (sub={}, CR2={:04X}, CR3={:04X}, CR4={:04X})",
    ...
    case 0:
        ...
        m_mpegWindow.fbPosX = static_cast<sint16>(m_CR[1]);
        m_mpegWindow.fbPosY = static_cast<sint16>(m_CR[2]);
        break;
    case 1:
        // Frame-buffer ratio: raw 16-bit X/Y wire values, decoded by the
        // overlay (1:1 encodes as $8011 on both axes).
        m_mpegWindow.fbRatioX = m_CR[1];
        m_mpegWindow.fbRatioY = m_CR[2];
        break;
    case 2:
        ...
        m_mpegWindow.dispPosX = static_cast<sint16>(m_CR[1]);
        m_mpegWindow.dispPosY = static_cast<sint16>(m_CR[2]);
        break;
    case 3:
        // Display size: visible extent (width, height). Zero means the
        // window was never configured; the overlay falls back to 1:1.
        m_mpegWindow.dispSizeW = m_CR[1];
        m_mpegWindow.dispSizeH = m_CR[2];
        break;
    default:
        break;
    }
