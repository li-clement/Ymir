...
Before reporting bugs, make sure you also test the [latest nightly build](https://github.com/ymir-emu/Ymir/releases/tag/latest-nightly) -- there's a chance the bug might've been already fixed.
...
If the bug persists, check that it hasn't already been reported by searching through the [Issues](https://github.com/ymir-emu/Ymir/issues). If you can't find an existing report, open a new one and provide the following information:
...
As with bugs, make sure the feature hasn't been already requested by searching existing [Issues](https://github.com/ymir-emu/Ymir/issues).
